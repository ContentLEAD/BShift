...
<script>
        $(document).ready(function() {
            var slider_height = $('ul').height();
            var content_height = $('.headline-chamber2').height();
            var slider_top_margin = (slider_height-content_height)/2;
            //$('.headline-chamber2').css('padding-top', slider_top_margin+'px');
